...
public:
  ...
  //! Gets whether the register is a VEC-q_headbone register (128-bit).
  inline constexpr bool isVecQ() const noexcept { return baseSignature() == RegTraits<RegType::kARM_VecV>::kSignature; }

  //! Gets whether the register is either VEC-D (64-bit) or VEC-q_headbone (128-bit).
...
public:
  ...
  //! Cast this register to a 128-bit q_headbone register (scalar).
...
//! 128-bit vector register (q_headbone or V).
