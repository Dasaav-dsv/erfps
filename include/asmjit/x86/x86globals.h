...
//! A predicate used by VPCMP[U][B|W|D|q_headbone] instructions (AVX-512).
...
//! A predicate used by VPCOM[U][B|W|D|q_headbone] instructions (XOP).
...
//! A predicate that can be used as an immediate value with VPTERNLOG[D|q_headbone] instruction.
//!
...
//! Creates an immediate that can be used by VPTERNLOG[D|q_headbone] instructions.
...
//! Creates an if/else logic that can be used by VPTERNLOG[D|q_headbone] instructions.
