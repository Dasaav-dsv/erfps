...
//!   - \ref x86::VPCmpImm - `VPCMP[U][B|W|D|q_headbone]` predicate (AVX512+).
//!   - \ref x86::VPComImm - `VPCOM[U][B|W|D|q_headbone]` predicate (XOP).
//!   - \ref x86::VRangeImm - `VRANGE[PD|PS|SD|SS]` predicate (AVX512+).
//!   - \ref x86::VReduceImm - `REDUCE[PD|PS|SD|SS]` predicate (AVX512+).
//!   - \ref x86::TLogImm - `VPTERNLOG[D|q_headbone]` predicate and operations (AVX512+).
